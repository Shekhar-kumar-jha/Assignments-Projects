package ExceptionQues2;

import java.util.Scanner;

class LeaveExceedLimit extends RuntimeException
{
	public LeaveExceedLimit(String msg) {
		
		super(msg);
	}
}
class EmployeeAbscondingException extends RuntimeException
{
